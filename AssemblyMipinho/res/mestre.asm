...
recebeC: 
	...
	#uma vez obtido o id do escravo que enviou a msg, é preciso copiar a linha para o local correto
	...
	#multiplicando o id pelo endereço. assim, o id=0 tera sua resposta copiada para o primeiro endereço, id=1 copiada para o segundo endereço, etc...
	#$t2 é o endereço da matriz resultante C
	muli $a2, $t2, $s3
	
	#agora $a2 contém o endereço correto
...
copia:	
	lw $a3, 0($t3)
		...
		#ajusta o endereço para apontar para o proximo elemento do vetor Aux
		addi $t3, $t3, 4
		
		#ajusta o endereço para apontar para o proximo elemento da linha correspondente da MatrizC
		addi $a2, $a2, 4
		
		#incrementa o contador de elementos copiados. Se 6 já tiverem sido copiados, acaba.
		
		addi $a0, $a0, 1
		bne $a0, $a1, copia
		
		#uma vez terminada a copia do vetor recem-chegado, é preciso verificar se todos os escravos já responderam. 
		#incrementa o numero de escravos que responderam
		addi $s2, $s2, 1
		
		bne $s2, $s1, recebeC
	
	    #terminou o recebimento das respostas de todos os escravos. a matriz C resultante está pronta.